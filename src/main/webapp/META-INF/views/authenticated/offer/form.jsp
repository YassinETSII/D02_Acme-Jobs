...
<acme:form readonly="true">
	...
	<acme:form-textarea code="authenticated.offer.form.label.minReward" path="minReward"/>
	<acme:form-textarea code="authenticated.offer.form.label.maxReward" path="maxReward"/>
