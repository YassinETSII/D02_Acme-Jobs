...
<acme:form readonly="true">
	<acme:form-textbox code="authenticated.investorRecord.form.label.investor" path="investor"/>
	...
	<acme:form-textbox code="authenticated.investorRecord.form.label.stars" path="stars"/>
