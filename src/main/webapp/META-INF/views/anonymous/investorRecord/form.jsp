...
<acme:form readonly="true">
	<acme:form-textbox code="anonymous.investorRecord.form.label.investor" path="investor"/>
	...
	<acme:form-textbox code="anonymous.investorRecord.form.label.stars" path="stars"/>
